...
<div id="swagger-ui">
    <div style="text-align: center; padding: 50px;">
        ...
        <p>Please wait while we load the API specification.</p>
    </div>
</div>
...
<script>
    window.onload = function() {
        ...
        @foreach($urlsToDocs as $title => $url)
            // Use the correct docs endpoint directly
            const apiUrl = "{{ $url }}";
            console.log('Loading API spec from:', apiUrl);
            urls.push({name: "{{ $title }}", url: apiUrl});
        @endforeach
